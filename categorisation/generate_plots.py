...
# dim = int(env_model_name.split('dim')[1].split('_')[0])
# if dim==6:
#     evaluate_smith1998(env_name=env_model_name, noises=[0.0], beta=beta, shuffles=[True], num_runs=50, num_eval_tasks=64, num_trials=300, synthetic=True, nonlinear=nonlinear, run=run)
