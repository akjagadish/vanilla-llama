from envs import SyntheticCategorisationTask
import argparse
import torch

def simulate(num_tasks, nonlinear, num_dims, max_steps, noise, shuffle, device, batch_size=64):
...
if __name__ == "__main__":
    ...
    simulate(args.num_tasks, args.nonlinear, args.num_dims, args.max_steps, args.noise, args.shuffle, device, args.batch_size)
