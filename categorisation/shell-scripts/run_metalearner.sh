...
# (ongoing) python rl2/train_transformer.py  --synthetic --num-episodes 500000 --max-steps 300 --num-dims 4 --env-name dim4synthetic --first-run-id 1 --save-every 100 --print-every 100  --noise 0.0 --model-name transformer --num_hidden 256 --num_layers 6 --d_model 64 --num_head 8 --batch_size 64 --shuffle
