...
# (done) python rl2/train_transformer.py  --rmc --env-name rmc_tasks_dim6_data600_tasks12911  --num-episodes 500000 --save-every 100 --print-every 10 --max-steps 600 --num-dims 6 --first-run-id 0 --noise 0.0 --model-name transformer --num_hidden 256 --num_layers 6 --d_model 64 --num_head 8 --batch_size 32 --shuffle --env-dir u/ajagadish/vanilla-llama/categorisation/data 
python rl2/train_transformer.py  --rmc --env-name rmc_tasks_dim6_data600_tasks12911 --sample-to-match-max-steps --num-episodes 500000 --save-every 100 --print-every 10 --max-steps 650 --num-dims 6 --first-run-id 0 --noise 0.0 --model-name transformer --num_hidden 256 --num_layers 6 --d_model 64 --num_head 8 --batch_size 32 --shuffle --env-dir u/ajagadish/vanilla-llama/categorisation/data 

# (ongoing) python rl2/train_transformer.py  --rmc --env-name rmc_tasks_dim4_data300_tasks8950  --num-episodes 500000 --save-every 100 --print-every 10 --max-steps 600 --num-dims 4 --first-run-id 0 --noise 0.0 --model-name transformer --num_hidden 256 --num_layers 6 --d_model 64 --num_head 8 --batch_size 64 --shuffle --env-dir u/ajagadish/vanilla-llama/categorisation/data 
...
# (done) python rl2/train_transformer.py  --synthetic --num-episodes 500000 --max-steps 300 --num-dims 4 --env-name dim4synthetic --first-run-id 1 --save-every 100 --print-every 100  --noise 0.0 --model-name transformer --num_hidden 256 --num_layers 6 --d_model 64 --num_head 8 --batch_size 64 --shuffle
