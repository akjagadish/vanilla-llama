...
python model_comparison/fit.py --model-name env=rmc_tasks_dim6_data600_tasks12911_model=transformer_num_episodes500000_num_hidden=256_lr0.0003_num_layers=6_d_model=64_num_head=8_noise0.0_shuffleTrue_run=0_rmc  --task-name devraj2022 --optimizer
